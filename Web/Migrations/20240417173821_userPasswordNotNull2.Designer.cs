...
namespace BackendLab01.Migrations
{
    ...
    [Migration("20240417173821_userPasswordNotNull2")]
    partial class userPasswordNotNull2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Infrastructure.EF.Nowy_folder.UserRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Infrastructure.EF.QuizEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Infrastructure.EF.QuizItemAnswerEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Infrastructure.EF.QuizItemEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Infrastructure.EF.QuizItemUserAnswerEntity", b =>
                {
            ...
            modelBuilder.Entity("Infrastructure.EF.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4a2ae6d5-dc60-4a4c-85e3-9bce5d5a242f",
                            Email = "321@gmail.com",
            ...
            modelBuilder.Entity("Infrastructure.EF.QuizItemUserAnswerEntity", b =>
                {
                    b.HasOne("Infrastructure.EF.QuizEntity", null)
                        .WithMany()
                        .HasForeignKey("QuizId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Infrastructure.EF.QuizItemEntity", "QuizItem")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("Infrastructure.EF.Nowy_folder.UserRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("QuizEntityQuizItemEntity", b =>
                {
                    b.HasOne("Infrastructure.EF.QuizItemEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("QuizItemAnswerEntityQuizItemEntity", b =>
                {
                    b.HasOne("Infrastructure.EF.QuizItemAnswerEntity", null)
                        .WithMany()
